...
def main() -> None:
    ...
    lease_manager = distributed_item_lease(
        root=distributed_step_runtime_root("07_train_series_model", "global"),
        lease_name="global",
        cfg=cfg,
        worker_id=worker_id,
        enabled=shared_workers,
        meta={"step": "07_train_series_model", "scope": "global", "worker_id": worker_id},
    )
    ...
    try:
        if not dataset_files:
            ...
            mark_step_completed("07_train_series_model", "global", {"series_model": "", "dataset_count": 0})
            return
