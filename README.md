...
- `Projekt`: lists imported source media, character/relationship/voice JSON databases, series-bible data, training results, generated workspaces, exports, logs, runtime/models, and GUI archives. Columns are resizable and the scan is bounded so very large NAS projects remain usable.
