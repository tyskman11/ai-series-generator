...
def main() -> None:
    ...
    if not adapter_rows:
        info("No adapter summary found. Run 10_train_adapter_models.py first.")
        return
    ...
    lease_root = distributed_step_runtime_root("11_train_fine_tune_models", "characters")
    reporter = LiveProgressReporter(
        script_name="11_train_fine_tune_models.py",
    ...
    for index, row in enumerate(filtered_rows, start=1):
        ...
        with distributed_item_lease(
            ...
            meta={"step": "11_train_fine_tune_models", "character": character_name, "slug": slug, "worker_id": worker_id},
        ) as acquired:
            if not acquired:
                continue
            ...
            summary_rows.append(
                {
                    ...
                    "autosave": load_step_autosave("11_train_fine_tune_models", autosave_target),
                }
            )
            reporter.update(
                index,
