...
def main() -> None:
    ...
    lease_root = distributed_step_runtime_root("10_train_adapter_models", "characters")
    reporter = LiveProgressReporter(
        script_name="10_train_adapter_models.py",
        total=len(manifests),
    ...
    for index, manifest in enumerate(manifests, start=1):
        ...
        with distributed_item_lease(
            ...
            meta={"step": "10_train_adapter_models", "character": character_name, "slug": slug, "worker_id": worker_id},
        ) as acquired:
            if not acquired:
                continue
            ...
            summary_rows.append(
                {
                    ...
                    "autosave": load_step_autosave("10_train_adapter_models", autosave_target),
                }
            )
            reporter.update(
                index,
