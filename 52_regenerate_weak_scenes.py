...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--strict",
        action="store_true",
        help="Forward --strict to 51_quality_gate.py when refreshing or applying the retry plan.",
    )
...
def apply_regeneration_request_to_scene_package(
    ...
    *,
    ...
    quality["last_regeneration_request_source"] = "52_regenerate_weak_scenes.py"
